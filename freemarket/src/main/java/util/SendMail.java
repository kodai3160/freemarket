...
public class SendMail {
	...
	public static void sendMail (String email, String name, String price, String nickname) {
		try {
			...
			text.append(name + "のご購入ありがとうございます。\n");
			text.append("以下内容でご注文を受け付けましたので、");
			text.append("ご連絡致します。\n\n");

			

			text.append("  " + price + "円\n\n");
			text.append("またのご利用よろしくお願いします。");
